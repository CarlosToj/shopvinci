...
```bash
git clone https://github.com/CarlosToj/shopvinci.git
cd shopvinci
```
...
|--------|-------|-----------|
| Carlos Eduardo Toj Dardón | 202403768 | Product Owner |
| Kelvin Estuardo Subuyuj Ajin | _________ | Scrum Master |
